              ...
              <div className="modal-body print-body" id="printable-content">
                <table className="print-table">
                  <tbody>
                    ...
                    <tr>
                      <td style={{ fontWeight: "bold" }}>Brought By Name:</td>
                      <td>{`${selectedPatient.BroughtBy?.Name || "..."}}`}</td>
                    </tr>
                    <tr>
                      <td style={{ fontWeight: "bold" }}>
                        Brought By Address:
                    ...
                    <tr>
                      <td style={{ fontWeight: "bold" }}>Brought By Aadhar:</td>
                      <td>{`${selectedPatient.BroughtBy?.Aadhar || "..."}`}</td>
                    </tr>
                    <tr>
